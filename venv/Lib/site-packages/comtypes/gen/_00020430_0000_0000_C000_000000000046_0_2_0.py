...
__all__ = [ 'OLE_YPOS_CONTAINER', 'Monochrome', 'OLE_XPOS_HIMETRIC',
           'Default', 'FONTSIZE', 'OLE_XPOS_PIXELS', 'IPictureDisp',
           'OLE_OPTEXCLUSIVE', 'StdFont', 'FONTUNDERSCORE',
           'LoadPictureConstants', 'OLE_XSIZE_CONTAINER',
           'OLE_TRISTATE', 'IFont', 'FontEvents',
           'OLE_XPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'StdPicture', 'Checked', 'OLE_YSIZE_PIXELS',
           'IFontEventsDisp', 'Gray', 'VgaColor', 'FONTNAME',
           'FONTITALIC', 'OLE_XSIZE_HIMETRIC', 'Picture',
           'OLE_HANDLE', 'FONTSTRIKETHROUGH', 'Unchecked', 'Font',
           'IPicture', 'Color', 'OLE_YPOS_HIMETRIC', 'IFontDisp',
           'OLE_XSIZE_PIXELS', 'OLE_YSIZE_HIMETRIC', 'OLE_COLOR',
           'OLE_YSIZE_CONTAINER', 'OLE_CANCELBOOL', 'OLE_YPOS_PIXELS']
from comtypes import _check_version; _check_version('', 1552970612.116597)
