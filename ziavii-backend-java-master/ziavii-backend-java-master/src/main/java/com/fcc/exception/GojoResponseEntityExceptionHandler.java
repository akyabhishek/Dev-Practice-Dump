...
import com.fcc.model.ExceptionResponse;


@ControllerAdvice
public class GojoResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(GojoException.class)
	public final ResponseEntity<Object> handleSmartAutoSafeException(GojoException ex, WebRequest request) throws Exception {
